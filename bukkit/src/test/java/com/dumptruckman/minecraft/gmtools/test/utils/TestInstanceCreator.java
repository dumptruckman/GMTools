...
public class TestInstanceCreator {
    ...
    public boolean setUp() {
        ...
        try {
            ...
            plugin = PowerMockito.spy(new GMToolsPlugin());

            // Let's let all MV files go to bin/test
            doReturn(pluginDirectory).when(plugin).getDataFolder();

            // Return a fake PDF file.
            PluginDescriptionFile pdf = new PluginDescriptionFile("GMTools", "dev",
                    "com.dumptruckman.minecraft.gmtools.GMToolsPlugin");
            ...
            when(mockPluginManager.getPlugin("GMTools")).thenReturn(plugin);
    ...
    public GMToolsPlugin getPlugin() {
        return this.plugin;
    }
