...
package com.dumptruckman.minecraft.gmtools.test;

import com.dumptruckman.minecraft.gmtools.GMToolsPlugin;
import com.dumptruckman.minecraft.pluginbase.config.BaseConfig;
import com.dumptruckman.minecraft.gmtools.test.utils.TestInstanceCreator;
...
@PrepareForTest({ GMToolsPlugin.class, AbstractBukkitPlugin.class})
public class TestBasics {
    ...
    public void testEnableDebugMode() {
        ...
        Plugin plugin = mockServer.getPluginManager().getPlugin("GMTools");
        GMToolsPlugin myPlugin = (GMToolsPlugin) plugin;
        ...
        when(mockCommand.getName()).thenReturn("gm");
